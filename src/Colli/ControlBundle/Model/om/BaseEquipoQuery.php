...
/**
 * @method EquipoQuery orderById($order = Criteria::ASC) Order by the id column
 * @method EquipoQuery orderByDescripcion($order = Criteria::ASC) Order by the descripcion column
 *
 * @method EquipoQuery groupById() Group by the id column
 * @method EquipoQuery groupByDescripcion() Group by the descripcion column
 *
 ...
 *
 * @method EquipoQuery leftJoinBodega($relationAlias = null) Adds a LEFT JOIN clause to the query using the Bodega relation
 * @method EquipoQuery rightJoinBodega($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Bodega relation
 * @method EquipoQuery innerJoinBodega($relationAlias = null) Adds a INNER JOIN clause to the query using the Bodega relation
 *
 ...
 *
 * @method Equipo findOneByDescripcion(string $descripcion) Return the first Equipo filtered by the descripcion column
 *
 * @method array findById(int $id) Return Equipo objects filtered by the id column
 * @method array findByDescripcion(string $descripcion) Return Equipo objects filtered by the descripcion column
 */
abstract class BaseEquipoQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Colli\\ControlBundle\\Model\\Equipo';
        }
    ...
    {
        $sql = 'SELECT `id`, `descripcion` FROM `equipo` WHERE `id` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(EquipoPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(EquipoPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(EquipoPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(EquipoPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EquipoPeer::ID, $id, $comparison);
    }
    ...
    public function filterByDescripcion($descripcion = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EquipoPeer::DESCRIPCION, $descripcion, $comparison);
    }
    ...
    public function filterByBodega($bodega, $comparison = null)
    {
        if ($bodega instanceof Bodega) {
            return $this
                ->addUsingAlias(EquipoPeer::ID, $bodega->getEquipoId(), $comparison);
     ...
     * @return EquipoQuery The current query, for fluid interface
     */
    public function joinBodega($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useBodegaQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
    ...
    {
        if ($equipo) {
            $this->addUsingAlias(EquipoPeer::ID, $equipo->getId(), Criteria::NOT_EQUAL);
        }
